...
The R-script [`Minimal-example-ellmer.R`](https://github.com/JoachimGoedhart/UvA-AIChat-API/blob/main/Minimal-example-ellmer.R) demonstrates the basic use of the LLM package `{ellmer}` that uses the UvA AI Chat API. 
